        ...
        <div className='grid max-w-7xl mt-48 mx-auto mb-16 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-5 md:p-0'>
            {
                interProducts.map((division, index) => (
                    <Link href={`/products/international#${division.name}`} key={index} className=" p-5 group cursor-pointer shadow-lg rounded-md shadow-black/30 hover:bg-orange-600 hover:text-white transition-all duration-300 ">
